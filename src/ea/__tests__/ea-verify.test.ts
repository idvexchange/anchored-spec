...
import { cleanupTestWorkspace, createTestWorkspace, makeArtifact, writeManifestProject, } from "../../test-helpers/workspace.js";
...
async function verifyArtifacts(prefix: string, artifacts: Array<ReturnType<typeof makeArtifact>>, options?: Parameters<typeof runEaVerification>[1]) {
...
describe("runEaVerification", () => {
    ...
    it("supports strict mode and rule overrides for current v2 findings", async () => {
        ...
        const overriddenResult = await verifyArtifacts("verify-overrides", artifacts, {
