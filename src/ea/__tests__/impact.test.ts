...
import { cleanupTestWorkspace, createTestWorkspace, makeArtifact, runCli, writeManifestProject } from "../../test-helpers/workspace.js";
...
describe("impact analysis", () => {
    it("analyzes transitive impact using Backstage entity refs", () => {
        const graph = buildRelationGraph(makeGraphArtifacts().map((artifact) => artifact), createDefaultRegistry());
